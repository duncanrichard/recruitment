        ...
        <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
            <div className="mx-auto max-w-7xl space-y-6">
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-3 max-w-3xl text-sm font-semibold leading-6 text-slate-200">
                                Monitoring hasil test MMPI berdasarkan tanggal kehadiran,
                                tanggal jadwal MMPI, status kehadiran, hasil test, dan demografi peserta.
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <ChartCard title="Status Kehadiran" description="Kehadiran peserta MMPI">
                        <ProgressList items={demografi.status_kehadiran || []} />
                    </ChartCard>

                    <ChartCard
                        title="Kombinasi Kehadiran & Hasil"
                        description="Analisa hasil MMPI berdasarkan kehadiran"
                    >
                        <ProgressList items={demografi.kehadiran_hasil || []} />
                    </ChartCard>

                    <ChartCard title="Top Tanggal MMPI" description="Tanggal MMPI dengan peserta terbanyak">
                        <ProgressList items={top.tanggal_mmpi || []} />
                    </ChartCard>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <ChartCard title="Kontak Terisi" description="Kelengkapan data kontak peserta">
